...
namespace The_Job_Box.Controllers
{
    ...
    public class EmployerController : Controller
    {
       ...
       private readonly IEmailSender _emailSender;
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (!await _roleManager.RoleExistsAsync(StaticData.Employer))
                    {
                        await _roleManager.CreateAsync(new IdentityRole(StaticData.Employer));
                    }

                    await _userManager.AddToRoleAsync(user, StaticData.Employer);
        ...
        [HttpGet]
        public IActionResult AccesStaticDataenied()
        {
            return View();
        }
