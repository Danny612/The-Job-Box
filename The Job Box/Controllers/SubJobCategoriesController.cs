...
using The_Job_Box.Models.SubJobCategoryViewModels;
using The_Job_Box.Utility;

namespace The_Job_Box.Controllers
{
    [Authorize(Roles = StaticData.AdminEndUser)]
    public class SubJobCategoriesController : Controller
    {
        ...
        {
            var subCategories = _db.SubCategory.Include(s => s.JobCategory);
        ...
        public IActionResult Create()
        {
            SubCategoryAndCategoryViewModel model = new SubCategoryAndCategoryViewModel()
            {
                ...
                SubCategory = new SubJobCategory(),
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var subCategory = await _db.SubCategory.Include(s => s.JobCategory).SingleOrDefaultAsync(m => m.Id == id);
            if (subCategory == null)
            {
                return NotFound();
            }
